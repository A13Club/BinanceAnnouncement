# Binance Futures Will Launch USDⓈ-Margined ELSAUSDT Perpetual Contract (2026-01-22)
...
2026-01-22 07:25 (UTC): ELSAUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractELSAUSDTLaunch Time2026-01-22 07:25 (UTC)Underlying AssetHeyElsa (ELSA)Project InfoHeyElsa is an AI-powered agentic layer for DeFi that transforms complex blockchain workflows into autonomous income streams.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 ELSAMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
