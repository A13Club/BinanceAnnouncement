# Binance USDC Reward Program: Up to 5.6% APR with USDC Flexible Products – 5,000 USDC Limit Available!
...
As part of the Binance USDC Reward Program, Binance Earn is pleased to announce another promotion for the USDC Simple Earn Flexible Products! During the Promotion Period, users who subscribe to USDC Flexible Products may enjoy up to 5.6% APR, including an exclusive Bonus Tiered APR on top of Real-Time APR rewards. 

Enjoy Up to 5.6% APR Rewards with USDC Flexible Products

Promotion Period: 2025-11-10 00:00 (UTC) to 2025-11-23 23:59 (UTC)Subscription Format: Complete subscription on a first-come, first-served basis in accordance with the terms below.Rewards Distribution:Bonus Tiered APR: Distributed to users’ Spot Accounts on a daily basis. The first reward will be given the day after accrual starts (two days after subscription).Real-Time APR: Accrued and directly accumulated in users’ Earn Accounts every minute.

Offered Products

Digital AssetDurationAPR During Promotion PeriodMin. Subscription Limit per UserMax. Subscription Limit per UserTier Range: Subscription Amount ≤ 5,000 USDCTier Range: Subscription Amount > 5,000 USDCUSDCFlexible5.6%（including 4% Bonus Tiered APR, approximately 1.6% Real-Time APR)1.6%（Approximately 1.6% Real-Time APR)0.1 USDC200 Million USDC
