...
2026-04-01 10:30 (UTC): PRLUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractPRLUSDTLaunch Time2026-04-01 10:30 (UTC)Underlying AssetPerle (PRL)Project InfoPerle Labs is a web3-powered AI platform on Solana that connects verified experts with enterprises and research teams to train and improve AI models.Settlement AssetUSDTTick Size0.0001Minimum Trade Amount1 PRLMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
