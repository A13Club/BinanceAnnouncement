# Deposit Alpha Tokens to Binance Alpha 2.0, Share the Alpha Token Reward Pool! (2025-11-20)

This is a general announcement and marketing communication. Products and services referred to here may not be available in your region.

Fellow Binancians,

Binance Alpha is launching a promotion for Alpha Token deposits and transfers to Alpha 2.0. Eligible users will have a chance to share the multi-Alpha Token reward pool when they complete the deposit and transfer tasks during the Promotion Period, distributed on a first-come, first-served basis. 

Promotion Period: 2025-11-20 12:30 (UTC) to 2025-11-27 12:30 (UTC)

Deposit Now

How to Participate: 

1. Deposit Eligible Tokens from External On-Chain Address to Binance Wallet (Keyless) 

Select "Binance Wallet (Keyless)” in “My Wallets”.Select [Receive] and deposit funds from an external on-chain address* to your Binance Wallet (Keyless).For more information on eligible tokens and minimum eligible deposit amounts, please refer to the task information table below.

2. Transfer Eligible Tokens from Binance Wallet (Keyless) to Alpha 2.0 Account

Switch to the [Exchange] tab on the Binance App and go to [Assets] - [Alpha] to view your Alpha 2.0 Account. Select [Transfer In] and transfer the specified amount of eligible tokens, according to the task information table below.

Task Information

Eligible TokenEligible Amount for Deposit and Transfer Rewards per Eligible UserTotal Number of Eligible Users for Deposit and Transfer TasksTotal Prize PoolPLAYSOLANA117 PLAYSOLANA1,170 PLAYSOLANALimited to the first 500 users585,000 PLAYSOLANAPLANCK80 PLANCK80 PLANCKLimited to the first 500 users40,000 PLANCK

Notes: 

External on-chain address*: A blockchain wallet address that is not imported into Binance, used for sending or receiving assets outside the Binance platform. Transfer assets using an imported wallet address to Binance Alpha 2.0 account will not be eligible for rewards.The Alpha transfer-in feature is available only in Binance App version 3.3.0 or above. Please make sure your app is updated to the latest version.
