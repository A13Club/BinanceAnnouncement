# Introducing Falcon Finance (FF) on Binance HODLer Airdrops! Earn FF With Retroactive BNB Simple Earn Subscriptions
...
Binance is excited to announce the 46th project on the HODLer Airdrops page - Falcon Finance (FF), an universal collateralization infrastructure powering onchain liquidity and yield.

Users who subscribed their BNB to Simple Earn (Flexible and/or Locked) and/or On-Chain Yields products from 2025-09-14 00:00 (UTC) to 2025-09-16 23:59 (UTC) will get the airdrops distribution. The HODLer Airdrops information is estimated to be available in 24 hours, and the new token will be distributed to users’ Spot Accounts at least 1 hour before trading starts.

Binance will then list FF at 2025-09-29 13:00 (UTC) and open trading against USDT, USDC, BNB, FDUSD, and TRY pairs. The seed tag will be applied to FF. Users can start depositing FF from 2025-09-26 10:00 (UTC).

*Please note that FF will be available on Binance Alpha and can be traded on Binance Alpha (time will be announced later), but FF will no longer be showcased on Binance Alpha after spot trading opens.

FF HODLer Airdrops Details

Token Name:Falcon Finance (FF)Total Token Supply: 10,000,000,000 FF Max Token Supply: 10,000,000,000 FF 

HODLer Airdrops Token Rewards: 150,000,000 FF (1.50% of max total token supply)An additional 150,000,000 FF will be allocated into future marketing campaigns 6 months later. Details will be shown in separate announcements.

Circulating Supply upon Listing on Binance: 2,340,000,000 FF (23.40% of max total token supply)

Smart Contract/Network Details:BNB Smart Chain (0xAC23B90A79504865D52B49B327328411a23d4dB2)Ethereum (0xFA1C09fC8B491B6A4d3Ff53A10CAd29381b3F949)Listing Fee: 0Research Report: Falcon Finance (FF) (will be available within 48 hours of publishing this announcement) BNB Holding Hard Cap: User’s Average BNB Holding / Total Average BNB Holding * 100% ≤ 4% (If the holding ratio is greater than 4%, the BNB holding ratio will be calculated as 4%)
...
Key highlights for Binance Alpha users:Users can transfer their FF from Alpha Accounts to Spot Accounts.FF will be delisted from Binance Alpha when spot trading opens on Binance Spot. Users will be able to continue to sell FF via Binance Alpha. After FF is delisted from Binance Alpha, users can still view their FF balance on their Alpha Accounts, and transfer them to Spot Accounts to continue trading on Binance Spot.Binance will transfer FF from users’ Alpha Accounts to Spot Accounts within 24 hours.Binance Alpha serves as a pre-listing token selection pool. Once a project featured on Binance Alpha is listed on Binance Spot, asset(s) will no longer be showcased on Binance Alpha.
