# Binance Square: Complete Tasks in the CreatorPad to Unlock 800,000 FF Token Voucher Rewards!

This is a general announcement. Products and services referred to here may not be available in your region. 

Fellow Binancians,

Binance Square is pleased to introduce a new campaign on CreatorPad, verified users may complete simple tasks to unlock 800,000 Falcon Finance (FF) token voucher rewards. CreatorPad is a one-stop platform on Binance Square where users can complete tasks to earn token rewards.

Activity Period: 2025-11-27 09:00 (UTC) to 2025-12-29 09:00 (UTC)
...
All verified Binance users can complete the following tasks to unlock a share of 720,000 FF in token vouchers. In addition, 80,000 FF token vouchers will be allocated to the top 50 creators on the Square Creator Leaderboard based on the 7-day rankings at the Activity launch date.

During the Activity Period, eligible users who successfully complete Tasks 1, 2, 3, 4 and choose between Tasks 5, 6, or 7 will qualify for a share of the 720,000 FF reward pool. 

Task 1: Follow the project’s account on Binance Square via the Activity landing page. Task 2: Follow the project’s account on X via the Activity landing page.Task 3: Create content on Binance Square with the following criteria: A minimum of 100 characters about the project;Use the hashtag #FalconFinance, $FF and mention the project’s account @falcon_finance;Content should be relevant to Falcon Finance and original to be eligible.

Task 4: Create content on X with the following criteria: A minimum of 100 characters about the project;Use the hashtag #FalconFinance, $FF and mention the project’s account @falconfinance;Content should be relevant to Falcon Finance and original to be eligible.Task 5: Trade a minimum of $10 equivalent in FF in a single transaction on Binance Spot.

Or

Task 6: Trade a minimum of $10 equivalent in FF in a single transaction on Binance Futures.

Or

Task 7: Trade a minimum of $10 equivalent in FF in a single transaction on Binance Convert.

Reward Structure: 

Eligible users are ranked based on the last 30 days leaderboard result at the Activity end date to qualify for the 720,000 FF reward pool, as per the table below.

Eligible WinnersAmount of FF Rewards (in Token Voucher)Reward Pool AllocationTop 100 creators on the FF 30D Project Leaderboard560,000 FFUser’s reward = (User’s mindshare/Total mindshare of top 100 creators) * 560,000 FFRemaining eligible participants who completed all tasks160,000 FFShared equally among eligible participants

Additional FF Reward for Top 50 Creators on Square Creator Leaderboard 

The top 50 creators will be eligible for this additional 80,000 FF prize pool. This reward is based on the 7-day rankings at the Activity launch date on the Square Creator Leaderboard. The 80,000 FF reward pool will be split amongst three ranking groups, as per the table below:

Ranking GroupsPercentage of FF to ShareTotal Amount of FF Rewards (in Token Voucher)Reward Pool Allocation150%40,000 FFShared equally among the 1st to 10th creators230%24,000 FFShared equally among the 11th to 30th creators320%16,000 FFShared equally among the 31st to 50th creators

Unlock Your FF Token Rewards Today! 
