...
Binance is excited to announce that Anoma (XAN) will open for trading on Binance Alpha starting 2025-09-23 10:00 (UTC). In addition, Binance Futures will launch XANUSDT Perpetual Contract with up to 50x leverage at 2025-09-23 10:30 (UTC).

Binance is the first platform to feature and open trading for Anoma (XAN) on Binance Alpha and Binance Futures. In celebration of this launch, there is an exclusive token airdrop for eligible Binance users. Eligible users need to use Binance Alpha Points to claim their airdrop on the Binance Alpha Events Page between 2025-09-23 10:00 (UTC) and 2025-09-24 10:00 (UTC). Binance Alpha Events Page can be accessed via the Binance App using the search function, and more information on how to claim the Alpha airdrop using Binance Alpha Points can be viewed here.

More details on the XANUSDT Perpetual Contract can be found in the table below:

USDⓈ-M Perpetual ContractXANUSDTLaunch Time2025-09-23 10:30 (UTC)Underlying AssetAnoma (XAN)Project InformationAnoma is a distributed operating system for intent-centric applications.Settlement AssetUSDTTick SizeTo be updated 15 minutes before the launch timeCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage50xTrading Hours24/7Multi-Assets ModeSupported
