# Introducing Yield Basis (YB) on Binance HODLer Airdrops! Earn YB With Retroactive BNB Simple Earn Subscriptions
...
Binance is excited to announce the 53rd project on the HODLer Airdrops page - Yield Basis (YB), a DeFi protocol that aims to provide yield to liquidity providers while mitigating impermanent loss through the use of leverage. 

Users who subscribed their BNB to Simple Earn (Flexible and/or Locked) and/or On-Chain Yields products from 2025-10-09 00:00 (UTC) to 2025-10-11 23:59 (UTC) will get the airdrops distribution. The HODLer Airdrops information is estimated to be available in 24 hours, and the new token will be distributed to users’ Spot Accounts at least 1 hour before trading starts.

Binance will then list YB at 2025-10-15 11:00 (UTC) and open trading against USDT, USDC, BNB, FDUSD, and TRY pairs. The seed tag will be applied to YB. Users can start depositing YB at 2025-10-14 12:00 (UTC). 

*Please note that YB will be available on Binance Alpha and can be traded on Binance Alpha (time will be announced later), but YB will no longer be showcased on Binance Alpha after spot trading opens.

YB HODLer Airdrops Details

Token Name: Yield Basis (YB)Total Token Supply at Genesis: 700,000,000 YB Max Token Supply: 1,000,000,000 YB 
...
Smart Contract/Network Details:BNB Smart Chain (0xFB93EE8152dd0a0e6F4b49C66c06d800Cf1Db72d)Ethereum (0x01791F726B4103694969820be083196cC7c045fF)Listing Fee: 0Research Report: Yield Basis (YB) (will be available within 48 hours of publishing this announcement) BNB Holding Hard Cap: User’s Average BNB Holding / Total Average BNB Holding * 100% ≤ 4% (If the holding ratio is greater than 4%, the BNB holding ratio will be calculated as 4%)
...
Key highlights for Binance Alpha users:Users can transfer their YB from Alpha Accounts to Spot Accounts.YB will be delisted from Binance Alpha when spot trading opens on Binance Spot. Users will be able to continue to sell YB via Binance Alpha. After YB is delisted from Binance Alpha, users can still view their YB balance on their Alpha Accounts, and transfer them to Spot Accounts to continue trading on Binance Spot.Binance will transfer YB from users’ Alpha Accounts to Spot Accounts within 24 hours.Binance Alpha serves as a pre-listing token selection pool. Once a project featured on Binance Alpha is listed on Binance Spot, asset(s) will no longer be showcased on Binance Alpha.
