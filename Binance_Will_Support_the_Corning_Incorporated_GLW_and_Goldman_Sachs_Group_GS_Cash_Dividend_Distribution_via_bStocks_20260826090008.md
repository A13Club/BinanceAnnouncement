...
Binance will support the Corning Incorporated (GLW) and Goldman Sachs Group (GS) cash dividend distribution via bStocks for GLWB and GSB holders. Net amount of the cash dividend will be reinvested after applicable withholding taxes, fees, costs, and other deductions, into additional units or fractions of the same underlying security. Eligible users will receive dividends in the form of GLWB and GSB bStocks respectively.

On-chain holders of GLWB and GSB will receive the bStock dividends through a multiplier adjustment.

Eligibility

Users with GLWB holdings on the record date snapshot at 2026-08-31 00:00 (UTC) will be eligible for the dividend distribution.Users with GSB holdings on the record date snapshot at 2026-09-01 00:00 (UTC) will be eligible for the dividend distribution.

General

Trading of GSB/USDT, GLWB/USDT will not be affected.GLWB:At 2026-08-28 23:30 (UTC), the token conversion service for 1:1 swaps between GLW stock and GLWB bStocks will be suspended.At 2026-08-30 23:30 (UTC), deposits and withdrawals of GLWB tokens will be suspended. Users should ensure they leave sufficient time for their GLWB token deposits to be fully processed prior to this time. GSB:At 2026-08-31 23:30 (UTC), the token conversion service for 1:1 swaps between GS stock and GSB bStocks will be suspended.At 2026-08-31 23:30 (UTC), deposits and withdrawals of GSB will be suspended. Users should ensure they leave sufficient time for their GSB deposits to be fully processed prior to this time. Deposits, withdrawals, and token conversion service for GSB and GLWB will resume when the distribution is completed. No further announcement will be posted. Users can also subscribe to the recovery notification where available.Dividends earned from assets held in other accounts will be credited to Spot Account, including but not limited to Savings Account, Margin Account, etc.Binance will handle all technical requirements for users who are involved in this event.Reinvestment and distribution of dividends is after deduction of withholding tax. Users may refer to the announcements from the companies for more information.For more information about bStocks dividend distribution, please refer to the FAQ.

Convert

Binance Convert will pause the conversion of GLWB and all associated pairs at 2026-08-30 23:30 (UTC).Binance Convert will pause the conversion of GSB and all associated pairs at 2026-08-31 23:30 (UTC).

Further Information:

Corning Incorporated Dividend HistoryGoldman Sachs Group Dividend History
