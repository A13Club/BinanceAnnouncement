# Binance Futures Will Launch USDⓈ-Margined RLSUSDT Perpetual Contract (2025-12-02)
...
2025-12-02 10:00 (UTC): RLSUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractRLSUSDTLaunch Time2025-12-02 10:00 (UTC)Underlying AssetRayls (RLS)Contract Address0x17ea10b6ae4fde59fdbf471bd28ab9710f508816Project InfoRayls is a financial infrastructure blockchain designed to connect traditional finance (TradFi) with decentralized finance (DeFi).Settlement AssetUSDTTick Size0.000001Capped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
