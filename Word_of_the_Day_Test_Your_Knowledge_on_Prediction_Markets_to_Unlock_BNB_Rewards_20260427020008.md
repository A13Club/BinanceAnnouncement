# Word of the Day: Test Your Knowledge on “Prediction Markets” to Unlock BNB Rewards!
...
Binance is pleased to launch a new Word of the Day (WOTD) game! The theme of this week’s WOTD is “Prediction Markets”. Read selected articles to learn more about this topic and participate in this week’s WOTD to grab a share of the rewards. 

Activity Period: 2026-04-27 00:00 (UTC) to 2026-05-03 23:59 (UTC)

Complete 3 Words to Unlock Your Share of 15 BNB
...
All eligible users may play up to two WOTD games per day to test their knowledge on the given topic.Users who achieve at least three correct answers during the Activity Period will be eligible to share a 15 BNB reward pool, distributed based on each user’s proportion of correct answers (User’s correct answers / Total correct answers of all eligible users), with a maximum reward cap of 0.01 BNB per user.All rewards will be distributed by 2026-05-17 23:59 (UTC) directly to the user’s Rewards Hub.Eligible users should claim their vouchers before the expiration date. No replacement reward will be provided. Learn how to redeem a Binance voucher.
...
Introducing Prediction Markets, Expanding Access to On-Chain Probability Trading - a Binance Wallet integration
