# Binance Futures Will Launch USDⓈ-Margined INXUSDT Perpetual Contract (2026-01-30)
...
2026-01-30 19:00 (UTC): INXUSDT Perpetual Contract with up to 50x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractINXUSDTLaunch Time2026-01-30 19:00 (UTC)Underlying AssetInfinex (INX)Project InfoInfinex is a wallet, portfolio manager, and trading terminal in one app.Settlement AssetUSDTTick Size0.000001Minimum Trade Amount1 INXMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage50xTrading Hours24/7Multi-Assets ModeSupported
