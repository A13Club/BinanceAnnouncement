...
2026-05-07 08:15 (UTC): BILLUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractBILLUSDTLaunch Time2026-05-07 08:15 (UTC)Underlying AssetBILL (Billions Network)Project InfoBillions Network is the universal Human and AI Network which lets anyone prove they are a real, unique person online in seconds, without revealing their underlying data.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 BILLMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
