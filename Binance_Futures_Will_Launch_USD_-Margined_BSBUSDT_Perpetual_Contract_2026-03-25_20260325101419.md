# Binance Futures Will Launch USDⓈ-Margined BSBUSDT Perpetual Contract (2026-03-25)
...
2026-03-25 11:45 (UTC): BSBUSDT Perpetual Contract with up to 10x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractBSBUSDTLaunch Time2026-03-25 11:45 (UTC)Underlying AssetBSB (Block Street)Project InfoBlock Street is the first Unified Liquidity Layer for on-chain capital markets.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 BSBMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage10xTrading Hours24/7Multi-Assets ModeSupported
