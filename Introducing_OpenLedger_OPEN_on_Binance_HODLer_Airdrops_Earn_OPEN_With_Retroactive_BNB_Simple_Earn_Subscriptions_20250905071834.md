# Introducing OpenLedger (OPEN) on Binance HODLer Airdrops! Earn OPEN With Retroactive BNB Simple Earn Subscriptions
...
Binance is excited to announce the 36th project on the HODLer Airdrops page – OpenLedger (OPEN),  an AI Blockchain, unlocking liquidity to monetize data, models and agents.

Users who subscribed their BNB to Simple Earn (Flexible and/or Locked) and/or On-Chain Yields products from 2025-08-18 00:00 (UTC) to 2025-08-21 23:59 (UTC) will get the airdrops distribution. The HODLer Airdrops information is estimated to be available in 24 hours, and the new token will be distributed to users’ Spot Accounts at least 1 hour before trading starts.

Binance will then list OPEN at 2025-09-08 13:00 (UTC) and open trading against USDT, USDC, BNB, FDUSD, and TRY pairs. The seed tag will be applied to OPEN. Users can start depositing OPEN at 2025-09-05 9:30 (UTC). 

*Please note that OPEN will be available on Binance Alpha and can be traded on Binance Alpha (time will be announced later), but OPEN will no longer be showcased on Binance Alpha after spot trading opens.

OPEN HODLer Airdrops Details

Token Name: OpenLedger (OPEN)Total Token Supply: 1,000,000,000 OPEN Max Token Supply: 1,000,000,000 OPEN 

HODLer Airdrops Token Rewards: 10,000,000 OPEN (1.00% of max total token supply)An additional 15,000,000 OPEN will be allocated 6 months later. Details will be shown in separate announcements.

Circulating Supply upon Listing on Binance: 215,500,000 OPEN (21.55% of max total token supply)

Smart Contract/Network Details:BNB Smart Chain (0xa227cc36938f0c9e09ce0e64dfab226cad739447)Ethereum (0xa227cc36938f0c9e09ce0e64dfab226cad739447)Listing Fee: 0Research Report: OpenLedger (OPEN) (will be available within 48 hours of publishing this announcement) BNB Holding Hard Cap: User’s Average BNB Holding / Total Average BNB Holding * 100% ≤ 4% (If the holding ratio is greater than 4%, the BNB holding ratio will be calculated as 4%)
...
Key highlights for Binance Alpha users:Users can transfer their OPEN from Alpha Accounts to Spot Accounts.OPEN will be delisted from Binance Alpha when spot trading opens on Binance Spot. Users will be able to continue to sell OPEN via Binance Alpha. After OPEN is delisted from Binance Alpha, users can still view their OPEN balance on their Alpha Account, and transfer them to Spot Accounts to continue trading on Binance Spot.Binance will transfer OPEN from users’ Alpha Accounts to Spot Accounts within 24 hours.Binance Alpha serves as a pre-listing token selection pool. Once a project featured on Binance Alpha is listed on Binance Spot, asset(s) will no longer be showcased on Binance Alpha.
