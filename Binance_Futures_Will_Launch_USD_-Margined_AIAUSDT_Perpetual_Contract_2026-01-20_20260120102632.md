# Binance Futures Will Launch USDⓈ-Margined AIAUSDT Perpetual Contract (2026-01-20)
...
2026-01-20 11:15 (UTC): AIAUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractAIAUSDTLaunch Time2026-01-20 11:15 (UTC)Underlying AssetDeAgentAI (AIA)Project InfoDeAgentAI is an AI infrastructure project designed to enable the creation, deployment, and coordination of autonomous agents in on-chain environments.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 AIAMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
