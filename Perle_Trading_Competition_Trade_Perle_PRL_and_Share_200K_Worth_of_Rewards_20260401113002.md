...
1st PRL Trading Competition Promotion Period: 2026-04-01 13:00 (UTC) to 2026-04-08 13:00 (UTC)2nd PRL Trading Competition Promotion Period: 2026-04-08 13:00 (UTC) to 2026-04-15 13:00 (UTC)

General Rules​​:

Participants will be ranked separately in each Promotion Period based on their total purchase volume of PRL tokens during the respective Promotion Period.

For each Promotion Period, the top 3,330 users by purchase volume of PRL tokens will share 799,200 PRL tokens equally, with each eligible user receiving 240 PRL tokens.

Please Note:​​

Only trades executed via ​​Binance Wallet (Keyless)​​ or ​​Binance Alpha​​ will qualify in this Promotion. Third-party dApp transactions are excluded.Only cumulative purchases count during the campaign. Selling is excluded.​​No Volume Caps​​: There is no cap on the trading volume for each participant in this Promotion.Token bridging transactions are not eligible for this Promotion.Effective from 2025-06-17 00:00 (UTC), trading volume generated from Alpha-to-Alpha token pairs will no longer be counted toward Alpha Points. Such trading volume will also be excluded from the Trading Competition and will not impact competition rankings.Reward Distribution:All rewards will be calculated in accordance with the reward distribution rules above and will be claimable in PRL tokens by eligible users.Token rewards will be made available to eligible users before 2026-04-29 13:00:00 (UTC). Eligible users must complete the claim within 14 days after rewards become claimable. Any rewards not claimed within this period will be deemed forfeited and will not be reissued.Eligible winners can view and claim their token rewards directly via their Binance Alpha accounts or Binance Wallet (Keyless).
