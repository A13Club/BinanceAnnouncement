# Binance Square: Complete Tasks in the CreatorPad to Unlock 833,333 YGG Token Voucher Rewards!

This is a general announcement. Products and services referred to here may not be available in your region. 

Fellow Binancians,

Binance Square is pleased to introduce a new campaign on CreatorPad, verified users may complete simple tasks to unlock 833,333 Yield Guild Games (YGG) token voucher rewards. CreatorPad is a one-stop platform on Binance Square where users can complete tasks to earn token rewards.

Activity Period: 2025-11-13 09:00 (UTC) to 2025-12-15 09:00 (UTC)
...
All verified Binance users can complete the following tasks to unlock a share of 833,333 YGG in token vouchers. 

During the Activity Period, eligible users who successfully complete Tasks 1, 2, 3, 4 and choose between Tasks 5, 6, or 7 will qualify for a share of 833,333 YGG reward pool. 

Task 1: Follow the project’s account on Binance Square via the Activity landing page. Task 2: Follow the project’s account on X via the Activity landing page.Task 3: Create content on Binance Square with the following criteria: A minimum of 100 characters about the project;Use the hashtag #YGGPlay, $YGG and mention the project’s account @yieldguildgames;Content should be relevant to YGG and original to be eligible.

Task 4: Create content on X with the following criteria: A minimum of 100 characters about the project;Use the hashtag #YGGPlay, $YGG and mention the project’s account @ygg_playContent should be relevant to YGG and original to be eligible.Task 5: Trade a minimum of $10 equivalent in YGG in a single transaction on Binance Spot.

Or

Task 6: Trade a minimum of $10 equivalent in YGG in a single transaction on Binance Futures.

Or

Task 7: Trade a minimum of $10 equivalent in YGG in a single transaction on Binance Convert.

Reward Structure: 

Eligible users are ranked based on the last 30 days leaderboard result at the Activity end date to qualify for the YGG reward pool, as per the table below.

Eligible WinnersAmount of YGG Rewards (in Token Voucher)Reward Pool AllocationTop 100 creators on Yield Guild Games 30D Project Leaderboard583,333 YGGUser’s reward = (User’s mindshare/Total mindshare of top 100 creators) * 583,333 YGGRemaining eligible participants who completed all tasks250,000 YGGShared equally among eligible participants

Unlock Your YGG Token Rewards Today! 
