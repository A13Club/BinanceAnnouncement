...
Binance Cross Margin, Portfolio Margin, and Portfolio Margin Pro will add two (2) bStocks tokens — Hims & Hers (HIMSB) and Salesforce (CRMB)— as eligible collateral assets at 2026-09-09 12:00 (UTC). The corresponding bStocks trading pair(s) will also be available for margin trading. Eligible users will be able to use this bStocks token as collateral in Margin, expanding their collateral options for margin trading.

Notes:

The above token(s) has been added as collateral asset(s) under Cross Margin, Portfolio Margin, and Portfolio Margin Pro only. Borrowing is not currently supported. Please stay tuned to future Binance announcements for updates.This feature is available to VIP 3 and above users in permitted jurisdictions only, and is not available to users in restricted regions.For the index price methodology of bStocks as collateral assets, please refer to the bStocks Tokenized Securities Collateral Index Price Methodology.Users are encouraged to adopt stringent risk management strategies and regularly monitor their margin levels when using bStocks as collateral.
