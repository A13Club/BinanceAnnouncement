...
2026-04-22 15:30 (UTC): OPGUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractOPGUSDTLaunch Time2026-04-22 15:30 (UTC)Underlying AssetOPG (OpenGradient)Project InfoOpenGradient is the Network for Open Intelligence, a decentralized infrastructure network designed to host, inference, and verify AI models at scale.Settlement AssetUSDTTick Size0.0001Minimum Trade Amount1 OPGMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
