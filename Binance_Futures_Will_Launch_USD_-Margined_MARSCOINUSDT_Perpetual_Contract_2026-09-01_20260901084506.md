...
2026-09-01 09:45 (UTC): MARSCOINUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractMARSCOINUSDTLaunch Time2026-09-01 09:45 (UTC)Underlying AssetMarsCoin (MARSCOIN)Project InfoA meme token built on the BNB Chain that uniquely rewards its holders with distributions of SPCXB, a tokenized stock asset.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 MARSCOINMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
