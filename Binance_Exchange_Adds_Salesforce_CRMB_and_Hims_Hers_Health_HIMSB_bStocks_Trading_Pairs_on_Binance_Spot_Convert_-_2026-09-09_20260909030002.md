...
To expand the list of trading choices offered on Binance Spot and enhance users’ trading experience, Binance Exchange will open trading at 2026-09-09 12:00 (UTC) and enable Spot Algo Trading Bots and Rebalancing Bots services for the bStocks Salesforce (CRMB) and Hims & Hers Health (HIMSB) trading pairs according to the following schedule:

Spot Algo Trading Bots: Aligned with Spot Listing TimeRebalancing Bots: Will be enabled within 24 hours of it being listed on Spot

In addition, users will be able to start trading bStocks against BTC, USDT, and any other tokens on Binance Convert at zero fees within one hour of bStocks being listed on Binance Spot.

Furthermore, users will enjoy zero maker fees for the aforementioned bStocks tradingpairs according to the following schedule:

CRMB/USDT and HIMSB/USDTPromotion Period: Listing time* to 2026-09-30 23:59 (UTC)

bStocks Tokenized Securities Details:

Users can start tokenizing their direct stock holdings into bStocks now, in preparation for trading. Conversion is 1:1 between each underlying stock and its bStocks, with zero conversion fees.Smart contracts (BNB Smart Chain):CRMB: 0x8c433eca1be0e2a357015602f63751c768f6f643HIMSB: 0xee6F4bcc88C2C8583d5a65c7D0C877b464100711Withdrawals for CRMB and HIMSB will open at 2026-09-09 13:00 (UTC).

Start Trading on Binance Spot Now!

Notes:

bStocks are not offered, sold, distributed, made available, or accessible in the United States or to, or for the account or benefit of, U.S. persons. bStocks have not been registered under the U.S. Securities Act of 1933 or any U.S. state securities laws and a public offering of bStocks will not be conducted in the United States or any other jurisdiction (other than the ADGM).
