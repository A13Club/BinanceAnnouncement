...
2026-04-16 03:30 (UTC): GENIUSUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractGENIUSUSDTLaunch Time2026-04-16 03:30 (UTC)Underlying AssetGENIUS (Genius Terminal)Project InfoGenius Terminal is the first private and final onchain terminal.Settlement AssetUSDTTick Size0.0001Minimum Trade Amount1 GENIUSMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
