...
2026-04-29 14:15 (UTC): AIGENSYNUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractAIGENSYNUSDTLaunch Time2026-04-29 14:15 (UTC)Underlying AssetAIGENSYN (Gensyn)Project InfoGensyn is a decentralized machine intelligence protocol designed to unify data and compute into a single, open network.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 AIGENSYNMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
