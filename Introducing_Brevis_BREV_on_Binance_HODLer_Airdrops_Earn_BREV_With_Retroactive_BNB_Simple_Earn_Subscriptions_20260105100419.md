# Introducing Brevis (BREV) on Binance HODLer Airdrops! Earn BREV With Retroactive BNB Simple Earn Subscriptions
...
Binance is excited to announce the 60th project on the HODLer Airdrops page - Brevis (BREV), a smart verifiable computing platform that provides the foundational infrastructure for scalable, trustless computation across blockchain, data and AI systems.

Users who subscribed their BNB to Simple Earn (Flexible and/or Locked) and/or On-Chain Yields products from 2025-12-17 00:00 (UTC) to 2025-12-19 23:59 (UTC) will get the airdrops distribution. The HODLer Airdrops information is estimated to be available in 24 hours, and the new token will be distributed to users’ Spot Accounts at least 1 hour before trading starts.

Binance will then list BREV at 2026-01-06 14:00 (UTC) and open trading against USDT, USDC, BNB and TRY pairs. The seed tag will be applied to BREV. Users can start depositing BREV at 2026-01-05 12:00 (UTC). 

*Please note that BREV will be available on Binance Alpha and can be traded on Binance Alpha (time will be announced later), but BREV will no longer be showcased on Binance Alpha after spot trading opens.

BREV HODLer Airdrops Details:

Token Name: Brevis (BREV)Total Token Supply: 1,000,000,000 BREVMax Token Supply: 1,000,000,000 BREV

HODLer Airdrops Token Rewards: 15,000,000 BREV (1.50% of max total token supply)An additional 5,000,000 BREV will be allocated into marketing campaigns after the spot listing. Details will be shown in separate announcements.

Circulating Supply upon Listing on Binance: 250,000,000 BREV (25.00% of max total token supply)

Smart Contract/Network Details:BNB Smart Chain (0x086F405146Ce90135750Bbec9A063a8B20A8bfFb)Ethereum (0x086F405146Ce90135750Bbec9A063a8B20A8bfFb)Base (0x086F405146Ce90135750Bbec9A063a8B20A8bfFb)Listing Fee: 0Research Report: Brevis (BREV) (will be available within 48 hours of publishing this announcement) BNB Holding Hard Cap: User’s Average BNB Holding / Total Average BNB Holding * 100% ≤ 4% (If the holding ratio is greater than 4%, the BNB holding ratio will be calculated as 4%)
...
Key highlights for Binance Alpha users:Users can transfer their BREV from Alpha Accounts to Spot Accounts when spot trading starts.BREV will be delisted from Binance Alpha when spot trading opens on Binance Spot. Users will be able to continue to sell BREV via Binance Alpha. After BREV is delisted from Binance Alpha, users can still view their BREV balance on their Alpha Accounts, and transfer them to Spot Accounts to continue trading on Binance Spot.Binance will transfer BREV from users’ Alpha Accounts to Spot Accounts within 24 hours.Binance Alpha serves as a pre-listing token selection pool. Once a project featured on Binance Alpha is listed on Binance Spot, asset(s) will no longer be showcased on Binance Alpha.
