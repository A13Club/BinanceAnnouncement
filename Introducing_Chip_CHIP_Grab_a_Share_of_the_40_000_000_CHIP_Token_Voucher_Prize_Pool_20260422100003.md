# Introducing Chip (CHIP): Grab a Share of the 40,000,000 CHIP Token Voucher Prize Pool!

This is a general announcement and marketing communication. Products and services referred to here may not be available in your region.

Fellow Binancians,

Binance Spot is excited to announce a new spot campaign for Chip (CHIP), A permissionless lending protocol built to finance AI infrastructure. The protocol enables GPU operators to tokenize their hardware as collateral and access financing instantaneously. Eligible users will have a chance to share a total prize pool of 40,000,000 CHIP in token vouchers! 

Promotion Period: 2026-04-22 11:00 (UTC) to 2026-05-13 11:00 (UTC)

Join Now

All User Trade Mission: Trade to Share Up to 8,000,000 CHIP

Eligibility: 

All verified new, regular users and all Binance VIP users can participate.Eligible pairs: CHIP/USDT, CHIP/USDC

How to Participate:

Click the [Join Now] button on the landing page to register.Trade a cumulative amount of at least 500 USD equivalent in any of the aforementioned eligible CHIP pairs on Binance Spot during the Promotion Period to earn a randomly generated reward of between 40 and 240 CHIP in token vouchers, limited to the first 80,000 users.

Trading Volume Tournament: Trade to Share Up to 32,000,000 CHIP

Eligibility: 

All verified new, regular users and all Binance VIP users can participate.Liquidity providers in the Binance Spot Liquidity Provider Program and Binance Brokers are not eligible to participate.Eligible pairs: CHIP/USDT, CHIP/USDC

How to Participate:

Click the [Join Now] button on the landing page to register.Trade a cumulative amount of at least 1,000 USD equivalent in any of the aforementioned eligible CHIP pairs on Binance Spot during the Promotion Period. Users who do not meet this threshold will not qualify for any reward under the Trading Volume Tournament.Rewards Calculation Logic: Your Final Allocation = (Your Trading Volume / Total Trading Volume of All Eligible Participants for Trading Volume Tournament) * Prize Pool 

Rewards for Trading Volume Tournament are capped at 40,000 CHIP in token vouchers per user.

Promotion Rules:

Trading volume of any zero-fee trading pairs is excluded from the final trading volume calculation.Transaction or gas fees will be excluded from the final trading volume calculation for each of the mission(s) and tournament(s).For each mission(s), token vouchers will be distributed to winning users on a first-come, first-served basis. Token vouchers for mission(s) and tournament(s) will be distributed to winning users by 2026-05-27, and will expire within 21 days after distribution. Users will be able to login and redeem their token voucher rewards via Profile > Rewards Hub.All eligible buy and sell orders will be counted towards the cumulative trading volume.The Spot Trading Volume leaderboard is updated hourly. The leaderboard will be displayed on the Spot landing page. Only users who have met the minimum qualifying trading volume threshold will be displayed on the leaderboard along with their trading volume.
