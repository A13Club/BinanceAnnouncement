# Grab a Share of 50,000 USDC Rewards on CreatorPad!

This is a general announcement. Products and services referred to here may not be available in your region. 

Fellow Binancians,     

Binance Square is pleased to introduce a new campaign on CreatorPad, verified users may complete simple tasks to unlock 50,000 USDC rewards from OpenLedger. 

Activity Period: 2026-05-19 09:00 (UTC) to 2026-06-02 23:59 (UTC)

Token Voucher Rewards Distribution: Before 2026-06-23

Unlock Your OpenLedger Rewards Today! 
...
Type of TaskTask DetailsPostCreate posts on Binance Square. Only posts that fit the following criteria will be eligible:Minimum 100 characters about the project;Use the hashtag #OpenLedger, tag $OPEN token and mention the project’s Square account OpenLeger (@OpenLedger);Content should be relevant to OpenLedger and original to be eligible.FollowFollow OpenLedger’s account on Binance Square and social media via the Activity landing page.TradeTrade a minimum of $10 equivalent in $OPEN in a single transaction. 
...
Eligible users are ranked based on the leaderboard result to qualify for the 50,000 USDC reward pool, as per the table below.

Note:

The project leaderboard displays data with a T+2 delay. For example, data of 2026-06-02 will be shown on the leaderboard page after 2026-06-04 09:00 (UTC). The “leaderboard snapshot date” refers to the cutoff date used to generate the leaderboard data. The leaderboard data is calculated up to that date, and the leaderboard is displayed T+2 days after the data cutoff.

Eligible WinnersLeaderboard Snapshot Date (the date on which points are calculated based on UTC time)Amount of RewardsReward Pool AllocationTop 300 creators on the OpenLedger Global Project Leaderboard2026-06-0225,000 USDCUser’s reward = (User’s points/Total points of the top 300 creators) * 25,000 USDCTop 300 eligible Chinese creators* on the OpenLedger Chinese Project Leaderboard2026-06-0225,000 USDCUser’s reward = (User’s points/Total points of the top 300 Chinese creators) * 25,000 USDC
