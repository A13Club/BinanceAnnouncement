...
2026-05-28 09:30 (UTC): CTRUSDT Perpetual Contract with up to 20x leverage

More details on the aforementioned perpetual contract(s) can be found in the table below:  

USDⓈ-M Perpetual ContractCTRUSDTLaunch Time2026-05-28 09:30 (UTC)Underlying AssetCTR (Citrea)Project InfoCTR is the coordination token of the Citrea Network, Bitcoin’s application layer enabling institutions and users to access Bitcoin capital markets.Settlement AssetUSDTTick Size0.00001Minimum Trade Amount1 CTRMinimum Notional Value5 USDTCapped Funding Rate+2.00% / -2.00%Funding Fee Settlement FrequencyEvery Four HoursMaximum Leverage20xTrading Hours24/7Multi-Assets ModeSupported
