# Binance Futures Will Launch USDⓈ-Margined ZAMAUSDT Perpetual Contract Pre-Market Trading (2026-01-09)

This is a general announcement. Products and services referred to here may not be available in your region.

Fellow Binancians,

To expand the list of trading choices offered on Binance Futures and to enhance users’ trading experience, Binance Futures will launch ZAMAUSDT perpetual contract pre-market trading starting at 2026-01-09 09:00 (UTC) with up to 5x leverage. 

More details on the aforementioned perpetual contract can be found in the table below:  

USDⓈ-M Perpetual ContractZAMAUSDTLaunch Time2026-01-09 09:00 (UTC)Underlying AssetZama Protocol (ZAMA)Project InformationZama Protocol is a cross-chain confidentiality layer that enables issuing, managing and trading assets confidentially on any L1 or L2, using Fully Homomorphic Encryption (FHE).Total Supply11,000,000,000 ZAMAMax SupplyInfiniteSettlement AssetUSDTTick Size0.0001Min Trade Amount1 ZAMAMin Notional Value5 USDTMark PriceAverage of the last 10 seconds of trade prices, calculated every second.*Please see the section belowCapped Funding RateDuring the pre-market trading period: +0.005%After the pre-market trading ends: +2.00% / -2.00%*Please see the section “About Funding Rates” belowFunding Fee Settlement FrequencyEvery Four HoursMaximum Leverage5xTrading Hours24/7Multi-Assets ModeSupported
