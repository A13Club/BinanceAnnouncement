# Introducing Walrus (WAL) on Binance HODLer Airdrops! Earn WAL With Retroactive BNB Simple Earn Subscriptions
...
Binance is excited to announce the 50th project on the HODLer Airdrops page - Walrus (WAL), a developer platform enabling data markets for the AI era, making data across all industries trustworthy, provable, monetizable, and secure.

Users who subscribed their BNB to Simple Earn (Flexible and/or Locked) and/or On-Chain Yields products from 2025-10-01 00:00 (UTC) to 2025-10-03 23:59 (UTC) will get the airdrops distribution. The HODLer Airdrops information is estimated to be available in 24 hours, and the new token will be distributed to users’ Spot Accounts at least 1 hour before trading starts.

Binance will then list WAL at 2025-10-10 7:30 (UTC) and open trading against USDT, USDC, BNB, FDUSD, and TRY pairs. The seed tag will be applied to WAL. Users can start depositing WAL at 2025-10-10 3:00 (UTC). 

*Please note that users can now trade WAL on Binance Alpha Market. However, once spot trading opens, WAL will no longer be showcased on Binance Alpha, and its trading volume will no longer be counted towards Alpha Points.

WAL HODLer Airdrops Details

Token Name: Walrus (WAL)Total Token Supply: 5,000,000,000 WAL Max Token Supply: 5,000,000,000 WAL

HODLer Airdrops Token Rewards: 32,500,000 WAL An additional 99,487,179 WAL will be allocated to marketing campaigns after the spot listing; Circulating Supply upon Listing on Binance:1,478,958,333 WAL (29.57% of Total Token Supply)

Smart Contract/Network Details:SUI Network (0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL)Listing Fee: 0Research Report: Walrus (WAL) (will be available within 48 hours of publishing this announcement) BNB Holding Hard Cap: User’s Average BNB Holding / Total Average BNB Holding * 100% ≤ 4% (If the holding ratio is greater than 4%, the BNB holding ratio will be calculated as 4%)
...
Key highlights for Binance Alpha users:Users can transfer their WAL from Alpha Accounts to Spot Accounts when spot trading starts.WAL will be delisted from Binance Alpha when spot trading opens on Binance Spot. Users will be able to continue to sell WAL via Binance Alpha. After WAL is delisted from Binance Alpha, users can still view their WAL balance on their Alpha Accounts, and transfer them to Spot Accounts to continue trading on Binance Spot.Binance will transfer WAL from users’ Alpha Accounts to Spot Accounts within 24 hours.Binance Alpha serves as a pre-listing token selection pool. Once a project featured on Binance Alpha is listed on Binance Spot, asset(s) will no longer be showcased on Binance Alpha.
