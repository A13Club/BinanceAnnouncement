# MetaArena Trading Competition: Trade MetaArena (TIMI) and Share $500K Worth of Rewards

This is a general announcement. Products and services referred to here may not be available in your region.

Fellow Binancians, 

Binance Wallet is excited to launch the MetaArena Trading Competition on Binance Alpha! During the Promotion Period, trade MetaArena (TIMI) in your Binance Wallet (Keyless) or via Binance Alpha to share exclusive token rewards. Any user who is eligible to trade Binance Alpha tokens is eligible to participate in this trading competition. 

1st TIMI Trading Competition Promotion Period: 2025-12-29 13:00 (UTC) to 2026-01-05 13:00 (UTC)2nd TIMI Trading Competition Promotion Period: 2026-01-05 13:00 (UTC) to 2026-01-12 13:00 (UTC)

General Rules​​:

Participants will be ranked separately in each Promotion Period based on their total purchase volume of TIMI tokens during the respective Promotion Period.

For each Promotion Period, the top 5,240 users by purchase volume of TIMI tokens will share 7,178,800 TIMI tokens equally, with each eligible user receiving 1,370 TIMI tokens.
