# BNB Smart Chain Trading Competition: Trade AT, BOS and COMMON to Share $1.6M Worth of Rewards

This is a general announcement. Products and services referred to here may not be available in your region.

Fellow Binancians, 

Binance Wallet is excited to launch the BNB Smart Chain Trading Competition on Binance Alpha! During the Promotion Period, trade APRO (AT), BitcoinOS (BOS) and COMMON (COMMON) via your Binance Wallet (Keyless) or Binance Alpha to share exclusive token rewards. Any user who is eligible to trade Binance Alpha tokens is eligible to participate in this trading competition. 

Promotion Period: 2025-11-11 16:00 (UTC) to 2025-11-25 16:00 (UTC)

General Rules​​:

Participants will be ranked according to their cumulative total trading volume on AT, BOS and COMMON during the Promotion Period. Top traders will receive rewards, as per the reward structure and table below.

Reward Structure:

Participants will be ranked across three independent categories​​:

AT Trading Volume Pool: The top 6,600 users by trading volume of AT tokens during the Promotion Period will share 1,254,000 AT tokens equally (= 190 AT per user).BOS Trading Volume Pool: The top 10,000 users by trading volume of BOS tokens during the Promotion Period will share 122,000,000 BOS tokens equally (= 12,200 BOS per user).COMMON Trading Volume Pool: The top 9,700 users by trading volume of COMMON tokens during the Promotion Period will share 47,530,000 COMMON tokens equally (= 4,900 COMMON per user).

Trading Task PoolsEligibility Qualified Trading PairsEstimated Total Prize Pool Reward per Eligible Winner (in Tokens)AT Volume PoolTop 6,600 users by trading volumeAll AT token pairs1,254,000 AT190 ATBOS Volume PoolTop 10,000 users by trading volumeAll BOS token pairs122,000,000 BOS12,200 BOSCOMMON Volume PoolTop 9,700 users by trading volumeAll COMMON token pairs47,530,000 COMMON4,900 COMMON
