...
Binance is excited to announce the 63rd project on the HODLer Airdrops page – USD.AI (CHIP), a permissionless lending protocol built to finance AI infrastructure. The protocol enables GPU operators to tokenize their hardware as collateral and access financing instantaneously.

Users who subscribed their BNB to Simple Earn (Flexible and/or Locked) and/or On-Chain Yields products from 2026-03-13 00:00 (UTC) to 2026-03-15 23:59 (UTC) will get the airdrops distribution. The airdrop is estimated to be distributed to eligible users’ Spot Accounts within 5 hours of this announcement.

CHIP HODLer Airdrops Details:

Token Name: USD.AI (CHIP)Total Token Supply: 10,000,000,000 CHIP Max Token Supply: 10,000,000,000 CHIP HODLer Airdrops Token Rewards: 25,000,000 CHIPCirculating Supply upon Listing on Binance: 2,000,000,000 CHIP (20% of Total Token Supply)Smart Contract Details:Ethereum (0x0C1c1C109FE34733fca54b82d7B46B75CFb71F6e)Arbitrum (0x0c1c1c109fe34733fca54b82d7b46b75cfb71f6e)Research Report: USD.AI (CHIP) (will be available within 48 hours of publishing this announcement)BNB Holding Hard Cap: User’s average BNB holding/ total average BNB holding * 100% ≤ 4% (If the holding ratio is greater than 4%, the BNB holding ratio will be calculated as 4%)
